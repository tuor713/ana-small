...
export async function executeJavaScript(
  ...
  console.log("Invoke exec-js", code, data);
  ...
  try {
    ...
    const registerVisualization = (
      ...
      const id = nanoid();
      console.log("Register visualization", type, data, options, id);
    ...
    const fn = new AsyncFunction(
      ...Object.keys(executionEnvironment),
      wrappedCode,
    );
    ...
    return {
      ...
      error:
        error instanceof Error
          ? error.message
          : "Unknown error during JavaScript execution",
    };
  }
}
